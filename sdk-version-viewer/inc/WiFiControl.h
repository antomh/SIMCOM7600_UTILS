...
typedef unsigned char uint8;
    ...
    * Input         : None
    * Output        : int *authType, int *encryptMode, char *pwd_str,
                      ap_index_type: 0-> ap
                                     1-> ap & ap
                                     2-> ap & sta
    * Return        : TRUE(1) or FALSE(0)
    ...
    *****************************************************************************/
    ...
    /*****************************************************************************
    * Function Name : get_w58l_client_count 
    * Description   : 获取W58L连接的客户端数
    * Input         : None
    * Output        : None
    * Return        : int： 连接总数
    * Auther        : zxs
    ...
    * Input     	: None
    * Output        : char *SSID, char *psk_value（密码）
    * Return        : TRUE(1) or FALSE(0)
    * Auther        : zxs
    * Date          : 2021.03.31
    *****************************************************************************/	
    ...
    * Input         : name_max_len pwd_max_len
    ...
    *****************************************************************************/		
    ...
    /*****************************************************************************
    * Function Name : set ssid and_auth
    * Description   : 设置AP 热点名称 auth类型, 加密模式, 密码
        ...
        Default value :
            ...
            ap_index_type: 0-> ap
                           1-> ap & ap
                           2-> ap & sta
    * Input         : char *ssid, char *password, int authType, int encryptMode, ,
                      ap_index_type: 0-> ap
                                     1-> ap & ap
                                     2-> ap & sta
    * Output        : None
    ...
    *****************************************************************************/	
    ...
    /*****************************************************************************
    * Function Name : wifi_is_sta_mode
    * Description   : 是否为STA模式
    * Input         : None
    * Output        : None
    * Return        : TRUE(1) or FALSE(0)
    * Auther        : zxs
