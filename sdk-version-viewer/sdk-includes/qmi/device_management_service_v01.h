...
//zhusilin add
#define QMI_DMS_MODEM_VERSION_MAX_V01 32
...
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}dms_get_modem_software_version_req_msg_v01;

typedef struct{
  qmi_response_type_v01 resp;
  char modem_software_version[QMI_DMS_MODEM_VERSION_MAX_V01 + 1];
}dms_get_modem_software_version_resp_msg_v01;
//zhusilin add end
...
typedef struct {
    ...
    /* Mandatory */
    uint32_t data_len;
    /**<   Must be set to # of elements in data */
    
    /* Mandatory */
    uint8_t data[512];
}dms_simcom_universal_interface_req_msg_v01;  /* Message */
...
typedef struct {
    ...
    /* Mandatory */
    uint8_t data[512];
}dms_simcom_universal_interface_resp_msg_v01;  /* Message */

/*for modem urc/event to ap*/
typedef struct {
    /* Mandatory */
    uint32_t result;
    ...
    /* Mandatory */
    uint8_t data[512];
}dms_simcom_universal_interface_ind_msg_v01;  /* Message */
//zhuxuesong add end
/**
    @}
  */
...
#define QMI_DMS_GET_MODEM_SOFTWARE_VERSION_REQ_V01   0x6f
#define QMI_DMS_GET_MODEM_SOFTWARE_VERSION_RESP_V01   0x6f
#define QMI_DMS_SIMCOM_UNIVERSAL_INTERFACE_REQ_V01   0x70  //zhuxuesong add
#define QMI_DMS_SIMCOM_UNIVERSAL_INTERFACE_RESP_V01   0x70 //zhuxuesong add
#define QMI_DMS_SIMCOM_UNIVERSAL_INTERFACE_IND_V01       0x70
